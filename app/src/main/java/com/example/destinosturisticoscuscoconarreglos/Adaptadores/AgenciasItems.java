...
public class AgenciasItems {
    ...
    static {
        addItem(new AgenciasItems.agenciasItems ("1","TaytaIntiTours", R.drawable.agenciasturisticasa,"aventura"));
        addItem(new AgenciasItems.agenciasItems("2","MachuppicchuAgency",R.drawable.agenciasturisticasb,"aventura"));
        addItem(new AgenciasItems.agenciasItems("3","Amaru", R.drawable.agenciasturisticasc,"aventura"));
        addItem(new AgenciasItems.agenciasItems("4","Viajes", R.drawable.destinoturisticosa,"aventura"));
        addItem(new AgenciasItems.agenciasItems("5","ViajesCusco", R.drawable.destinoturisticosb,"aventura"));
        addItem(new AgenciasItems.agenciasItems("6","LugarBonito", R.drawable.destinoturisticosc,"aventura"));
    }
